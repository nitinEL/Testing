...
//        gridManager.A = new List<List<string>>();
//        gridManager.B = new List<List<string>>();
//        gridManager.C = new List<List<string>>();
//        gridManager.MainGrid = new List<List<string>>();
//        gridManager.SecondMainGrid = new List<List<string>>();
//        gridManager.ThirdMainGrid = new List<List<string>>();
...
//        Debug.Log("<color=red> Multi Tumble </color>");
...
//                                _isAdd = true;
//                                _count = CalculateTotalMatchCountInABoard(itemData._itemName, 1, itemData.maxRowCount, boardDatas);
//                            }
//                        }
...
//                            boardDatas[i].row[_matchIndex[i]] = sprite;
//                            _isAdd = true;
//                            _count = CalculateTotalMatchCountInABoard(itemData._itemName, itemData.itemTotalMatchCount, itemData.maxRowCount, boardDatas);
//                        }
...
//            if (_itemCount == 1)
//                _tempList = gridManager.A;
//            else if (_itemCount == 2)
//                _tempList = gridManager.B;
//            else if (_itemCount == 3)
//                _tempList = gridManager.C;
...
//            gridManager.MainGrid = new List<List<string>>();
//            _tempList1 = gridManager.MainGrid;

//            listOfBoardDatas.Reverse();

//            foreach (var item in listOfBoardDatas)
//            {
...
//            mainGridData = CheckTumbleGroup.instance.CheckGroup(listOfBoardDatas, tumbleDatas);
...
//                                {
//                                    boardDatas[i].row[_randomRowNumber] = itemSprites.Find(A => A.GetName() == item._itemName);
//                                    j++;
//                                }
//                            }
